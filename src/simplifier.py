...
STEP_TACTICS: dict[str, str] = {
    ...
    # memory -> low_degree_bus: drop rewrite/z3; monolithic bus asserts are huge.
    "low_degree_bus": TACTIC_QEPREFIX + ":bounds:bitwise:mod_inv:demod:domain_probe:normalize:demod",
}
