...
_DEFAULT_TACTIC = (
    "nnf:evaluator:skolem:isolate:lift:witness:array_subst:z3-propagate-values:isqf:bounds:rewrite:gxor:mod_inv:demod:z3-propagate-values:domain_probe:pretty"
)
