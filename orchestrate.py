...
_DEFAULT_TACTIC = (
    "nnf:evaluator:skolem:lift:witness:demod:z3-propagate-values:flatten_outer_array:isqf:bounds:rewrite:bitwise:mod_inv:demod:domain_probe:z3-propagate-values:z3-solve-eqs:demod:normalize_eqs:demod:pretty"
)
